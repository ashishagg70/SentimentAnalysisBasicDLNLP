...
function renderRating(_data) {
  ...
  graphs = document.getElementById("review-graphs")
  p = window.location.pathname
  p= p.substring(0, p.lastIndexOf("/"))
  p= p.substring(0, p.lastIndexOf("/"))
  graphs.innerHTML = '<iframe style="width:1140px;height:1180px;border:none;" src=file://'+ p+"/"+_data.html+' title="description">' + graphs.innerHTML
}
